...
var rsrcMngr = {
	...
	init: function (clbk) {
		...
		setInterval(function () {
			rsrcMngr.loadFeeds("http://cdn-int.montiera.com/data/coms/wghts.js", "/data/wghts.js", function () {
				wghts.loadWghts(function (status) {
					utl.log("[rsrcmngr.js][init][wghts.reload] - status = [" + status + "]");
				});
			});
